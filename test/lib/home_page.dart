...
class _LeftWidgetState extends State<LeftWidget> with TickerProviderStateMixin {
  List<String> _list = ["Cà phê", "Bánh mì", "Trà đá", "Đậu"];
      ...
      child: Stack(
        children: <Widget>[
          ...
          Positioned(
            ...
            child: CustomPaint(
              painter: CheckPointPainter(Offset(10, -90)),
            ),
          )
        ],
      ),
...
class CheckPointPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    canvas.drawArc(
        Rect.fromCircle(
            center: Offset(offset.dx, offset.dy - 10), radius: radius),
        startAngle,
        sweepAngle,
        false,
        paint);
    ...
    paint.color = Colors.grey;
    canvas.drawCircle(
        Offset(offset.dx - pointRadius / 2, offset.dy - pointRadius / 2 - 10),
        pointRadius,
        paint);
  }
    ...
    return Container(
      ...
      child: Padding(
        ...
        child: Text(
          name,
          style: TextStyle(
            color: checked ? Color(0xff98162d) : Colors.black,
            fontSize: 16,
          ),
        ),
      ),
